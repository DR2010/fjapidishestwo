...
// Hcomplexlist is a function to return a list of dishes
func Hcomplexlist(httpwriter http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		complexlist, err2 := complexModel.ComplexGetall()
		if err2 != nil {
			fmt.Println(err2)
		} else {
			json.NewEncoder(httpwriter).Encode(&complexlist)
		}
	}
}

// Hcomplexadd is a function to return a list of dishes
func Hcomplexadd(httpwriter http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		complextoadd := models.Complex{}
		complextoadd.Name = req.FormValue("complexname") // This is the key, must be unique
		complextoadd.Streetname = req.FormValue("streetname")
		complextoadd.Streetnumber, err = strconv.Atoi(req.FormValue("streetnumber"))
		complextoadd.UPNumber = req.FormValue("upnumber")
		complextoadd.UpdatedBy = req.FormValue("upnumber")
...
func Hdishfind(httpwriter http.ResponseWriter, httprequest *http.Request) {
	...
	dishfound, _ = dishes.DishFind(dishtofind)
...
func Hdishadd(httpwriter http.ResponseWriter, req *http.Request) {
	...
	_, recordstatus := dishes.DishFind(dishtoadd.Name)
...
func Hdishupdate(httpwriter http.ResponseWriter, req *http.Request) {
	...
	ret := dishes.Dishupdate(dishtoupdate)
...
func Hdishdelete(httpwriter http.ResponseWriter, req *http.Request) {
	...
	ret := dishes.Dishdelete(dishtoupdate)
...
func Hdishalsolist(httpwriter http.ResponseWriter, req *http.Request) {
	...
	var dishlist = dishes.DishGetall()
...
func Hdishlistbyevent(httpwriter http.ResponseWriter, req *http.Request) {
	...
	var dishlist = dishes.DishGetByActivity(activitytype)
...
func Hdishlistavailable(httpwriter http.ResponseWriter, req *http.Request) {
	...
	var dishlist = dishes.DishGetAvailable()
