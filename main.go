...
func loadreferencedatainredis() {
	...
	err = redisclient.Set(sysid+"API.MySQL.Location", variable.MySQLLocation, 0).Err()
	err = redisclient.Set(sysid+"API.MySQL.ConnString", variable.MySQLConnString, 0).Err()
